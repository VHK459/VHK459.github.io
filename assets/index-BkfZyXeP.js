...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ta,depthTest:!1,depthWrite:!1})}function HR(r,e,n){const a=new Float32Array(qr),o=new K(0,1,0);return new In({name:"SphericalGaussianBlur",defines:{n:qr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${r}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:a},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:o}},vertexShader:qc(),fragmentShader:`
...
}`,Rw=[new K(1,0,0),new K(-1,0,0),new K(0,1,0),new K(0,-1,0),new K(0,0,1),new K(0,0,-1)],Cw=[new K(0,-1,0),new K(0,-1,0),new K(0,0,1),new K(0,0,-1),new K(0,-1,0),new K(0,-1,0)],rx=new tn,vl=new K,Bd=new K;function ww(r,e,n){let a=new gS;const o=new nt,u=new nt,c=new cn,h=new zT,p=new HT,m={},g=n.maxTextureSize,_={[vr]:ei,[ei]:vr,[wa]:wa},v=new In({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new nt},radius:{value:4}},vertexShader:Tw,fragmentShader:Aw}),E=v.clone();E.defines.HORIZONTAL_PASS=1;const b=new ra;b.setAttribute("position",new ia(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const T=new Vi(b,v),y=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Cc;let x=this.type;this.render=function(B,I,j){if(y.enabled===!1||y.autoUpdate===!1&&y.needsUpdate===!1||B.length===0)return;B.type===wM&&(lt("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),B.type=Cc);const C=r.getRenderTarget(),L=r.getActiveCubeFace(),k=r.getActiveMipmapLevel(),re=r.state;re.setBlending(ta),re.buffers.depth.getReversed()===!0?re.buffers.color.setClear(0,0,0,0):re.buffers.color.setClear(1,1,1,1),re.buffers.depth.setTest(!0),re.setScissorTest(!1);const ae=x!==this.type;ae&&I.traverse(function(de){de.material&&(Array.isArray(de.material)?de.material.forEach(ce=>ce.needsUpdate=!0):de.material.needsUpdate=!0)});for(let de=0,ce=B.length;de<ce;de++){const F=B[de],H=F.shadow;if(H===void 0){lt("WebGLShadowMap:",F,"has no shadow.");continue}if(H.autoUpdate===!1&&H.needsUpdate===!1)continue;o.copy(H.mapSize);const W=H.getFrameExtents();if(o.multiply(W),u.copy(H.mapSize),(o.x>g||o.y>g)&&(o.x>g&&(u.x=Math.floor(g/W.x),o.x=u.x*W.x,H.mapSize.x=u.x),o.y>g&&(u.y=Math.floor(g/W.y),o.y=u.y*W.y,H.mapSize.y=u.y)),H.map===null||ae===!0){if(H.map!==null&&(H.map.depthTexture!==null&&(H.map.depthTexture.dispose(),H.map.depthTexture=null),H.map.dispose()),this.type===yl){if(F.isPointLight){lt("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}H.map=new ti(o.x,o.y,{format:oo,type:fi,minFilter:Gn,magFilter:Gn,generateMipmaps:!1}),H.map.texture.name=F.name+".shadowMap",H.map.depthTexture=new Ul(o.x,o.y,$i),H.map.depthTexture.name=F.name+".shadowMapDepth",H.map.depthTexture.format=Oa,H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Sn,H.map.depthTexture.magFilter=Sn}else{F.isPointLight?(H.map=new _S(o.x),H.map.depthTexture=new FT(o.x,aa)):(H.map=new ti(o.x,o.y),H.map.depthTexture=new Ul(o.x,o.y,aa)),H.map.depthTexture.name=F.name+".shadowMap",H.map.depthTexture.format=Oa;const ye=r.state.buffers.depth.getReversed();this.type===Cc?(H.map.depthTexture.compareFunction=ye?sm:rm,H.map.depthTexture.minFilter=Gn,H.map.depthTexture.magFilter=Gn):(H.map.depthTexture.compareFunction=null,H.map.depthTexture.minFilter=Sn,H.map.depthTexture.magFilter=Sn)}H.camera.updateProjectionMatrix()}const ve=H.map.isWebGLCubeRenderTarget?6:1;for(let ye=0;ye<ve;ye++){if(H.map.isWebGLCubeRenderTarget)r.setRenderTarget(H.map,ye),r.clear();else{ye===0&&(r.setRenderTarget(H.map),r.clear());const U=H.getViewport(ye);c.set(u.x*U.x,u.y*U.y,u.x*U.z,u.y*U.w),re.viewport(c)}if(F.isPointLight){const U=H.camera,ee=H.matrix,xe=F.distance||U.far;xe!==U.far&&(U.far=xe,U.updateProjectionMatrix()),vl.setFromMatrixPosition(F.matrixWorld),U.position.copy(vl),Bd.copy(U.position),Bd.add(Rw[ye]),U.up.copy(Cw[ye]),U.lookAt(Bd),U.updateMatrixWorld(),ee.makeTranslation(-vl.x,-vl.y,-vl.z),rx.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),H._frustum.setFromProjectionMatrix(rx,U.coordinateSystem,U.reversedDepth)}else H.updateMatrices(F);a=H.getFrustum(),N(I,j,H.camera,F,this.type)}H.isPointLightShadow!==!0&&this.type===yl&&D(H,j),H.needsUpdate=!1}x=this.type,y.needsUpdate=!1,r.setRenderTarget(C,L,k)};function D(B,I){const j=e.update(T);v.defines.VSM_SAMPLES!==B.blurSamples&&(v.defines.VSM_SAMPLES=B.blurSamples,E.defines.VSM_SAMPLES=B.blurSamples,v.needsUpdate=!0,E.needsUpdate=!0),B.mapPass===null&&(B.mapPass=new ti(o.x,o.y,{format:oo,type:fi})),v.uniforms.shadow_pass.value=B.map.depthTexture,v.uniforms.resolution.value=B.mapSize,v.uniforms.radius.value=B.radius,r.setRenderTarget(B.mapPass),r.clear(),r.renderBufferDirect(I,null,j,v,T,null),E.uniforms.shadow_pass.value=B.mapPass.texture,E.uniforms.resolution.value=B.mapSize,E.uniforms.radius.value=B.radius,r.setRenderTarget(B.map),r.clear(),r.renderBufferDirect(I,null,j,E,T,null)}function w(B,I,j,C){let L=null;const k=j.isPointLight===!0?B.customDistanceMaterial:B.customDepthMaterial;if(k!==void 0)L=k;else if(L=j.isPointLight===!0?p:h,r.localClippingEnabled&&I.clipShadows===!0&&Array.isArray(I.clippingPlanes)&&I.clippingPlanes.length!==0||I.displacementMap&&I.displacementScale!==0||I.alphaMap&&I.alphaTest>0||I.map&&I.alphaTest>0||I.alphaToCoverage===!0){const re=L.uuid,ae=I.uuid;let de=m[re];de===void 0&&(de={},m[re]=de);let ce=de[ae];ce===void 0&&(ce=L.clone(),de[ae]=ce,I.addEventListener("dispose",P)),L=ce}if(L.visible=I.visible,L.wireframe=I.wireframe,C===yl?L.side=I.shadowSide!==null?I.shadowSide:I.side:L.side=I.shadowSide!==null?I.shadowSide:_[I.side],L.alphaMap=I.alphaMap,L.alphaTest=I.alphaToCoverage===!0?.5:I.alphaTest,L.map=I.map,L.clipShadows=I.clipShadows,L.clippingPlanes=I.clippingPlanes,L.clipIntersection=I.clipIntersection,L.displacementMap=I.displacementMap,L.displacementScale=I.displacementScale,L.displacementBias=I.displacementBias,L.wireframeLinewidth=I.wireframeLinewidth,L.linewidth=I.linewidth,j.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const re=r.properties.get(L);re.light=j}return L}function N(B,I,j,C,L){if(B.visible===!1)return;if(B.layers.test(I.layers)&&(B.isMesh||B.isLine||B.isPoints)&&(B.castShadow||B.receiveShadow&&L===yl)&&(!B.frustumCulled||a.intersectsObject(B))){B.modelViewMatrix.multiplyMatrices(j.matrixWorldInverse,B.matrixWorld);const ae=e.update(B),de=B.material;if(Array.isArray(de)){const ce=ae.groups;for(let F=0,H=ce.length;F<H;F++){const W=ce[F],ve=de[W.materialIndex];if(ve&&ve.visible){const ye=w(B,ve,C,L);B.onBeforeShadow(r,B,I,j,ae,ye,W),r.renderBufferDirect(j,null,ae,ye,B,W),B.onAfterShadow(r,B,I,j,ae,ye,W)}}}else if(de.visible){const ce=w(B,de,C,L);B.onBeforeShadow(r,B,I,j,ae,ce,null),r.renderBufferDirect(j,null,ae,ce,B,null),B.onAfterShadow(r,B,I,j,ae,ce,null)}}const re=B.children;for(let ae=0,de=re.length;ae<de;ae++)N(re[ae],I,j,C,L)}function P(B){B.target.removeEventListener("dispose",P);for(const j in m){const C=m[j],L=B.target.uuid;L in C&&(C[L].dispose(),delete C[L])}}}const Dw={[jd]:Zd,[Kd]:$d,[Qd]:ep,[ro]:Jd,[Zd]:jd,[$d]:Kd,[ep]:Qd,[Jd]:ro};function Lw(r,e){function n(){let X=!1;const Oe=new cn;let Re=null;const Be=new cn(0,0,0,0);return{setMask:function(Me){Re!==Me&&!X&&(r.colorMask(Me,Me,Me,Me),Re=Me)},setLocked:function(Me){X=Me},setClear:function(Me,Se,we,st,Bt){Bt===!0&&(Me*=st,Se*=st,we*=st),Oe.set(Me,Se,we,st),Be.equals(Oe)===!1&&(r.clearColor(Me,Se,we,st),Be.copy(Oe))},reset:function(){X=!1,Re=null,Be.set(-1,0,0,0)}}}function a(){let X=!1,Oe=!1,Re=null,Be=null,Me=null;return{setReversed:function(Se){if(Oe!==Se){const we=e.get("EXT_clip_control");Se?we.clipControlEXT(we.LOWER_LEFT_EXT,we.ZERO_TO_ONE_EXT):we.clipControlEXT(we.LOWER_LEFT_EXT,we.NEGATIVE_ONE_TO_ONE_EXT),Oe=Se;const st=Me;Me=null,this.setClear(st)}},getReversed:function(){return Oe},setTest:function(Se){Se?fe(r.DEPTH_TEST):Ue(r.DEPTH_TEST)},setMask:function(Se){Re!==Se&&!X&&(r.depthMask(Se),Re=Se)},setFunc:function(Se){if(Oe&&(Se=Dw[Se]),Be!==Se){switch(Se){case jd:r.depthFunc(r.NEVER);break;case Zd:r.depthFunc(r.ALWAYS);break;case Kd:r.depthFunc(r.LESS);break;case ro:r.depthFunc(r.LEQUAL);break;case Qd:r.depthFunc(r.EQUAL);break;case Jd:r.depthFunc(r.GEQUAL);break;case $d:r.depthFunc(r.GREATER);break;case ep:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}Be=Se}},setLocked:function(Se){X=Se},setClear:function(Se){Me!==Se&&(Oe&&(Se=1-Se),r.clearDepth(Se),Me=Se)},reset:function(){X=!1,Re=null,Be=null,Me=null,Oe=!1}}}function o(){let X=!1,Oe=null,Re=null,Be=null,Me=null,Se=null,we=null,st=null,Bt=null;return{setTest:function(Rt){X||(Rt?fe(r.STENCIL_TEST):Ue(r.STENCIL_TEST))},setMask:function(Rt){Oe!==Rt&&!X&&(r.stencilMask(Rt),Oe=Rt)},setFunc:function(Rt,Fn,wi){(Re!==Rt||Be!==Fn||Me!==wi)&&(r.stencilFunc(Rt,Fn,wi),Re=Rt,Be=Fn,Me=wi)},setOp:function(Rt,Fn,wi){(Se!==Rt||we!==Fn||st!==wi)&&(r.stencilOp(Rt,Fn,wi),Se=Rt,we=Fn,st=wi)},setLocked:function(Rt){X=Rt},setClear:function(Rt){Bt!==Rt&&(r.clearStencil(Rt),Bt=Rt)},reset:function(){X=!1,Oe=null,Re=null,Be=null,Me=null,Se=null,we=null,st=null,Bt=null}}}const u=new n,c=new a,h=new o,p=new WeakMap,m=new WeakMap;let g={},_={},v=new WeakMap,E=[],b=null,T=!1,y=null,x=null,D=null,w=null,N=null,P=null,B=null,I=new _t(0,0,0),j=0,C=!1,L=null,k=null,re=null,ae=null,de=null;const ce=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let F=!1,H=0;const W=r.getParameter(r.VERSION);W.indexOf("WebGL")!==-1?(H=parseFloat(/^WebGL (\d)/.exec(W)[1]),F=H>=1):W.indexOf("OpenGL ES")!==-1&&(H=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),F=H>=2);let ve=null,ye={};const U=r.getParameter(r.SCISSOR_BOX),ee=r.getParameter(r.VIEWPORT),xe=new cn().fromArray(U),Ce=new cn().fromArray(ee);function Ge(X,Oe,Re,Be){const Me=new Uint8Array(4),Se=r.createTexture();r.bindTexture(X,Se),r.texParameteri(X,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(X,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let we=0;we<Re;we++)X===r.TEXTURE_3D||X===r.TEXTURE_2D_ARRAY?r.texImage3D(Oe,0,r.RGBA,1,1,Be,0,r.RGBA,r.UNSIGNED_BYTE,Me):r.texImage2D(Oe+we,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,Me);return Se}const ie={};ie[r.TEXTURE_2D]=Ge(r.TEXTURE_2D,r.TEXTURE_2D,1),ie[r.TEXTURE_CUBE_MAP]=Ge(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),ie[r.TEXTURE_2D_ARRAY]=Ge(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),ie[r.TEXTURE_3D]=Ge(r.TEXTURE_3D,r.TEXTURE_3D,1,1),u.setClear(0,0,0,1),c.setClear(1),h.setClear(0),fe(r.DEPTH_TEST),c.setFunc(ro),ft(!1),rn(fv),fe(r.CULL_FACE),vt(ta);function fe(X){g[X]!==!0&&(r.enable(X),g[X]=!0)}function Ue(X){g[X]!==!1&&(r.disable(X),g[X]=!1)}function We(X,Oe){return _[X]!==Oe?(r.bindFramebuffer(X,Oe),_[X]=Oe,X===r.DRAW_FRAMEBUFFER&&(_[r.FRAMEBUFFER]=Oe),X===r.FRAMEBUFFER&&(_[r.DRAW_FRAMEBUFFER]=Oe),!0):!1}function Ve(X,Oe){let Re=E,Be=!1;if(X){Re=v.get(Oe),Re===void 0&&(Re=[],v.set(Oe,Re));const Me=X.textures;if(Re.length!==Me.length||Re[0]!==r.COLOR_ATTACHMENT0){for(let Se=0,we=Me.length;Se<we;Se++)Re[Se]=r.COLOR_ATTACHMENT0+Se;Re.length=Me.length,Be=!0}}else Re[0]!==r.BACK&&(Re[0]=r.BACK,Be=!0);Be&&r.drawBuffers(Re)}function gt(X){return b!==X?(r.useProgram(X),b=X,!0):!1}const an={[Yr]:r.FUNC_ADD,[LM]:r.FUNC_SUBTRACT,[UM]:r.FUNC_REVERSE_SUBTRACT};an[NM]=r.MIN,an[OM]=r.MAX;const Et={[PM]:r.ZERO,[IM]:r.ONE,[FM]:r.SRC_COLOR,[Yd]:r.SRC_ALPHA,[kM]:r.SRC_ALPHA_SATURATE,[GM]:r.DST_COLOR,[zM]:r.DST_ALPHA,[BM]:r.ONE_MINUS_SRC_COLOR,[qd]:r.ONE_MINUS_SRC_ALPHA,[VM]:r.ONE_MINUS_DST_COLOR,[HM]:r.ONE_MINUS_DST_ALPHA,[XM]:r.CONSTANT_COLOR,[WM]:r.ONE_MINUS_CONSTANT_COLOR,[YM]:r.CONSTANT_ALPHA,[qM]:r.ONE_MINUS_CONSTANT_ALPHA};function vt(X,Oe,Re,Be,Me,Se,we,st,Bt,Rt){if(X===ta){T===!0&&(Ue(r.BLEND),T=!1);return}if(T===!1&&(fe(r.BLEND),T=!0),X!==DM){if(X!==y||Rt!==C){if((x!==Yr||N!==Yr)&&(r.blendEquation(r.FUNC_ADD),x=Yr,N=Yr),Rt)switch(X){case io:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Wd:r.blendFunc(r.ONE,r.ONE);break;case hv:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case dv:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:Lt("WebGLState: Invalid blending: ",X);break}else switch(X){case io:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case Wd:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case hv:Lt("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case dv:Lt("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:Lt("WebGLState: Invalid blending: ",X);break}D=null,w=null,P=null,B=null,I.set(0,0,0),j=0,y=X,C=Rt}return}Me=Me||Oe,Se=Se||Re,we=we||Be,(Oe!==x||Me!==N)&&(r.blendEquationSeparate(an[Oe],an[Me]),x=Oe,N=Me),(Re!==D||Be!==w||Se!==P||we!==B)&&(r.blendFuncSeparate(Et[Re],Et[Be],Et[Se],Et[we]),D=Re,w=Be,P=Se,B=we),(st.equals(I)===!1||Bt!==j)&&(r.blendColor(st.r,st.g,st.b,Bt),I.copy(st),j=Bt),y=X,C=!1}function Ut(X,Oe){X.side===wa?Ue(r.CULL_FACE):fe(r.CULL_FACE);let Re=X.side===ei;Oe&&(Re=!Re),ft(Re),X.blending===io&&X.transparent===!1?vt(ta):vt(X.blending,X.blendEquation,X.blendSrc,X.blendDst,X.blendEquationAlpha,X.blendSrcAlpha,X.blendDstAlpha,X.blendColor,X.blendAlpha,X.premultipliedAlpha),c.setFunc(X.depthFunc),c.setTest(X.depthTest),c.setMask(X.depthWrite),u.setMask(X.colorWrite);const Be=X.stencilWrite;h.setTest(Be),Be&&(h.setMask(X.stencilWriteMask),h.setFunc(X.stencilFunc,X.stencilRef,X.stencilFuncMask),h.setOp(X.stencilFail,X.stencilZFail,X.stencilZPass)),Jt(X.polygonOffset,X.polygonOffsetFactor,X.polygonOffsetUnits),X.alphaToCoverage===!0?fe(r.SAMPLE_ALPHA_TO_COVERAGE):Ue(r.SAMPLE_ALPHA_TO_COVERAGE)}function ft(X){L!==X&&(X?r.frontFace(r.CW):r.frontFace(r.CCW),L=X)}function rn(X){X!==RM?(fe(r.CULL_FACE),X!==k&&(X===fv?r.cullFace(r.BACK):X===CM?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):Ue(r.CULL_FACE),k=X}function G(X){X!==re&&(F&&r.lineWidth(X),re=X)}function Jt(X,Oe,Re){X?(fe(r.POLYGON_OFFSET_FILL),(ae!==Oe||de!==Re)&&(r.polygonOffset(Oe,Re),ae=Oe,de=Re)):Ue(r.POLYGON_OFFSET_FILL)}function At(X){X?fe(r.SCISSOR_TEST):Ue(r.SCISSOR_TEST)}function It(X){X===void 0&&(X=r.TEXTURE0+ce-1),ve!==X&&(r.activeTexture(X),ve=X)}function Ze(X,Oe,Re){Re===void 0&&(ve===null?Re=r.TEXTURE0+ce-1:Re=ve);let Be=ye[Re];Be===void 0&&(Be={type:void 0,texture:void 0},ye[Re]=Be),(Be.type!==X||Be.texture!==Oe)&&(ve!==Re&&(r.activeTexture(Re),ve=Re),r.bindTexture(X,Oe||ie[X]),Be.type=X,Be.texture=Oe)}function O(){const X=ye[ve];X!==void 0&&X.type!==void 0&&(r.bindTexture(X.type,null),X.type=void 0,X.texture=void 0)}function M(){try{r.compressedTexImage2D(...arguments)}catch(X){Lt("WebGLState:",X)}}function Y(){try{r.compressedTexImage3D(...arguments)}catch(X){Lt("WebGLState:",X)}}function pe(){try{r.texSubImage2D(...arguments)}catch(X){Lt("WebGLState:",X)}}function be(){try{r.texSubImage3D(...arguments)}catch(X){Lt("WebGLState:",X)}}function ue(){try{r.compressedTexSubImage2D(...arguments)}catch(X){Lt("WebGLState:",X)}}function Qe(){try{r.compressedTexSubImage3D(...arguments)}catch(X){Lt("WebGLState:",X)}}function De(){try{r.texStorage2D(...arguments)}catch(X){Lt("WebGLState:",X)}}function Ye(){try{r.texStorage3D(...arguments)}catch(X){Lt("WebGLState:",X)}}function rt(){try{r.texImage2D(...arguments)}catch(X){Lt("WebGLState:",X)}}function Te(){try{r.texImage3D(...arguments)}catch(X){Lt("WebGLState:",X)}}function Ae(X){xe.equals(X)===!1&&(r.scissor(X.x,X.y,X.z,X.w),xe.copy(X))}function ze(X){Ce.equals(X)===!1&&(r.viewport(X.x,X.y,X.z,X.w),Ce.copy(X))}function Fe(X,Oe){let Re=m.get(Oe);Re===void 0&&(Re=new WeakMap,m.set(Oe,Re));let Be=Re.get(X);Be===void 0&&(Be=r.getUniformBlockIndex(Oe,X.name),Re.set(X,Be))}function Le(X,Oe){const Be=m.get(Oe).get(X);p.get(Oe)!==Be&&(r.uniformBlockBinding(Oe,Be,X.__bindingPointIndex),p.set(Oe,Be))}function dt(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),c.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),g={},ve=null,ye={},_={},v=new WeakMap,E=[],b=null,T=!1,y=null,x=null,D=null,w=null,N=null,P=null,B=null,I=new _t(0,0,0),j=0,C=!1,L=null,k=null,re=null,ae=null,de=null,xe.set(0,0,r.canvas.width,r.canvas.height),Ce.set(0,0,r.canvas.width,r.canvas.height),u.reset(),c.reset(),h.reset()}return{buffers:{color:u,depth:c,stencil:h},enable:fe,disable:Ue,bindFramebuffer:We,drawBuffers:Ve,useProgram:gt,setBlending:vt,setMaterial:Ut,setFlipSided:ft,setCullFace:rn,setLineWidth:G,setPolygonOffset:Jt,setScissorTest:At,activeTexture:It,bindTexture:Ze,unbindTexture:O,compressedTexImage2D:M,compressedTexImage3D:Y,texImage2D:rt,texImage3D:Te,updateUBOMapping:Fe,uniformBlockBinding:Le,texStorage2D:De,texStorage3D:Ye,texSubImage2D:pe,texSubImage3D:be,compressedTexSubImage2D:ue,compressedTexSubImage3D:Qe,scissor:Ae,viewport:ze,reset:dt}}function Uw(r,e,n,a,o,u,c){const h=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,p=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),m=new nt,g=new WeakMap;let _;const v=new WeakMap;let E=!1;try{E=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function b(O,M){return E?new OffscreenCanvas(O,M):Dl("canvas")}function T(O,M,Y){let pe=1;const be=Ze(O);if((be.width>Y||be.height>Y)&&(pe=Y/Math.max(be.width,be.height)),pe<1)if(typeof HTMLImageElement<"u"&&O instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&O instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&O instanceof ImageBitmap||typeof VideoFrame<"u"&&O instanceof VideoFrame){const ue=Math.floor(pe*be.width),Qe=Math.floor(pe*be.height);_===void 0&&(_=b(ue,Qe));const De=M?b(ue,Qe):_;return De.width=ue,De.height=Qe,De.getContext("2d").drawImage(O,0,0,ue,Qe),lt("WebGLRenderer: Texture has been resized from ("+be.width+"x"+be.height+") to ("+ue+"x"+Qe+")."),De}else return"data"in O&&lt("WebGLRenderer: Image in DataTexture is too big ("+be.width+"x"+be.height+")."),O;return O}function y(O){return O.generateMipmaps}function x(O){r.generateMipmap(O)}function D(O){return O.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:O.isWebGL3DRenderTarget?r.TEXTURE_3D:O.isWebGLArrayRenderTarget||O.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function w(O,M,Y,pe,be=!1){if(O!==null){if(r[O]!==void 0)return r[O];lt("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+O+"'")}let ue=M;if(M===r.RED&&(Y===r.FLOAT&&(ue=r.R32F),Y===r.HALF_FLOAT&&(ue=r.R16F),Y===r.UNSIGNED_BYTE&&(ue=r.R8)),M===r.RED_INTEGER&&(Y===r.UNSIGNED_BYTE&&(ue=r.R8UI),Y===r.UNSIGNED_SHORT&&(ue=r.R16UI),Y===r.UNSIGNED_INT&&(ue=r.R32UI),Y===r.BYTE&&(ue=r.R8I),Y===r.SHORT&&(ue=r.R16I),Y===r.INT&&(ue=r.R32I)),M===r.RG&&(Y===r.FLOAT&&(ue=r.RG32F),Y===r.HALF_FLOAT&&(ue=r.RG16F),Y===r.UNSIGNED_BYTE&&(ue=r.RG8)),M===r.RG_INTEGER&&(Y===r.UNSIGNED_BYTE&&(ue=r.RG8UI),Y===r.UNSIGNED_SHORT&&(ue=r.RG16UI),Y===r.UNSIGNED_INT&&(ue=r.RG32UI),Y===r.BYTE&&(ue=r.RG8I),Y===r.SHORT&&(ue=r.RG16I),Y===r.INT&&(ue=r.RG32I)),M===r.RGB_INTEGER&&(Y===r.UNSIGNED_BYTE&&(ue=r.RGB8UI),Y===r.UNSIGNED_SHORT&&(ue=r.RGB16UI),Y===r.UNSIGNED_INT&&(ue=r.RGB32UI),Y===r.BYTE&&(ue=r.RGB8I),Y===r.SHORT&&(ue=r.RGB16I),Y===r.INT&&(ue=r.RGB32I)),M===r.RGBA_INTEGER&&(Y===r.UNSIGNED_BYTE&&(ue=r.RGBA8UI),Y===r.UNSIGNED_SHORT&&(ue=r.RGBA16UI),Y===r.UNSIGNED_INT&&(ue=r.RGBA32UI),Y===r.BYTE&&(ue=r.RGBA8I),Y===r.SHORT&&(ue=r.RGBA16I),Y===r.INT&&(ue=r.RGBA32I)),M===r.RGB&&(Y===r.UNSIGNED_INT_5_9_9_9_REV&&(ue=r.RGB9_E5),Y===r.UNSIGNED_INT_10F_11F_11F_REV&&(ue=r.R11F_G11F_B10F)),M===r.RGBA){const Qe=be?Bc:Ct.getTransfer(pe);Y===r.FLOAT&&(ue=r.RGBA32F),Y===r.HALF_FLOAT&&(ue=r.RGBA16F),Y===r.UNSIGNED_BYTE&&(ue=Qe===Vt?r.SRGB8_ALPHA8:r.RGBA8),Y===r.UNSIGNED_SHORT_4_4_4_4&&(ue=r.RGBA4),Y===r.UNSIGNED_SHORT_5_5_5_1&&(ue=r.RGB5_A1)}return(ue===r.R16F||ue===r.R32F||ue===r.RG16F||ue===r.RG32F||ue===r.RGBA16F||ue===r.RGBA32F)&&e.get("EXT_color_buffer_float"),ue}function N(O,M){let Y;return O?M===null||M===aa||M===wl?Y=r.DEPTH24_STENCIL8:M===$i?Y=r.DEPTH32F_STENCIL8:M===Cl&&(Y=r.DEPTH24_STENCIL8,lt("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):M===null||M===aa||M===wl?Y=r.DEPTH_COMPONENT24:M===$i?Y=r.DEPTH_COMPONENT32F:M===Cl&&(Y=r.DEPTH_COMPONENT16),Y}function P(O,M){return y(O)===!0||O.isFramebufferTexture&&O.minFilter!==Sn&&O.minFilter!==Gn?Math.log2(Math.max(M.width,M.height))+1:O.mipmaps!==void 0&&O.mipmaps.length>0?O.mipmaps.length:O.isCompressedTexture&&Array.isArray(O.image)?M.mipmaps.length:1}function B(O){const M=O.target;M.removeEventListener("dispose",B),j(M),M.isVideoTexture&&g.delete(M)}function I(O){const M=O.target;M.removeEventListener("dispose",I),L(M)}function j(O){const M=a.get(O);if(M.__webglInit===void 0)return;const Y=O.source,pe=v.get(Y);if(pe){const be=pe[M.__cacheKey];be.usedTimes--,be.usedTimes===0&&C(O),Object.keys(pe).length===0&&v.delete(Y)}a.remove(O)}function C(O){const M=a.get(O);r.deleteTexture(M.__webglTexture);const Y=O.source,pe=v.get(Y);delete pe[M.__cacheKey],c.memory.textures--}function L(O){const M=a.get(O);if(O.depthTexture&&(O.depthTexture.dispose(),a.remove(O.depthTexture)),O.isWebGLCubeRenderTarget)for(let pe=0;pe<6;pe++){if(Array.isArray(M.__webglFramebuffer[pe]))for(let be=0;be<M.__webglFramebuffer[pe].length;be++)r.deleteFramebuffer(M.__webglFramebuffer[pe][be]);else r.deleteFramebuffer(M.__webglFramebuffer[pe]);M.__webglDepthbuffer&&r.deleteRenderbuffer(M.__webglDepthbuffer[pe])}else{if(Array.isArray(M.__webglFramebuffer))for(let pe=0;pe<M.__webglFramebuffer.length;pe++)r.deleteFramebuffer(M.__webglFramebuffer[pe]);else r.deleteFramebuffer(M.__webglFramebuffer);if(M.__webglDepthbuffer&&r.deleteRenderbuffer(M.__webglDepthbuffer),M.__webglMultisampledFramebuffer&&r.deleteFramebuffer(M.__webglMultisampledFramebuffer),M.__webglColorRenderbuffer)for(let pe=0;pe<M.__webglColorRenderbuffer.length;pe++)M.__webglColorRenderbuffer[pe]&&r.deleteRenderbuffer(M.__webglColorRenderbuffer[pe]);M.__webglDepthRenderbuffer&&r.deleteRenderbuffer(M.__webglDepthRenderbuffer)}const Y=O.textures;for(let pe=0,be=Y.length;pe<be;pe++){const ue=a.get(Y[pe]);ue.__webglTexture&&(r.deleteTexture(ue.__webglTexture),c.memory.textures--),a.remove(Y[pe])}a.remove(O)}let k=0;function re(){k=0}function ae(){const O=k;return O>=o.maxTextures&&lt("WebGLTextures: Trying to use "+O+" texture units while this GPU supports only "+o.maxTextures),k+=1,O}function de(O){const M=[];return M.push(O.wrapS),M.push(O.wrapT),M.push(O.wrapR||0),M.push(O.magFilter),M.push(O.minFilter),M.push(O.anisotropy),M.push(O.internalFormat),M.push(O.format),M.push(O.type),M.push(O.generateMipmaps),M.push(O.premultiplyAlpha),M.push(O.flipY),M.push(O.unpackAlignment),M.push(O.colorSpace),M.join()}function ce(O,M){const Y=a.get(O);if(O.isVideoTexture&&At(O),O.isRenderTargetTexture===!1&&O.isExternalTexture!==!0&&O.version>0&&Y.__version!==O.version){const pe=O.image;if(pe===null)lt("WebGLRenderer: Texture marked for update but no image data found.");else if(pe.complete===!1)lt("WebGLRenderer: Texture marked for update but image is incomplete");else{ie(Y,O,M);return}}else O.isExternalTexture&&(Y.__webglTexture=O.sourceTexture?O.sourceTexture:null);n.bindTexture(r.TEXTURE_2D,Y.__webglTexture,r.TEXTURE0+M)}function F(O,M){const Y=a.get(O);if(O.isRenderTargetTexture===!1&&O.version>0&&Y.__version!==O.version){ie(Y,O,M);return}else O.isExternalTexture&&(Y.__webglTexture=O.sourceTexture?O.sourceTexture:null);n.bindTexture(r.TEXTURE_2D_ARRAY,Y.__webglTexture,r.TEXTURE0+M)}function H(O,M){const Y=a.get(O);if(O.isRenderTargetTexture===!1&&O.version>0&&Y.__version!==O.version){ie(Y,O,M);return}n.bindTexture(r.TEXTURE_3D,Y.__webglTexture,r.TEXTURE0+M)}function W(O,M){const Y=a.get(O);if(O.isCubeDepthTexture!==!0&&O.version>0&&Y.__version!==O.version){fe(Y,O,M);return}n.bindTexture(r.TEXTURE_CUBE_MAP,Y.__webglTexture,r.TEXTURE0+M)}const ve={[ip]:r.REPEAT,[Da]:r.CLAMP_TO_EDGE,[ap]:r.MIRRORED_REPEAT},ye={[Sn]:r.NEAREST,[KM]:r.NEAREST_MIPMAP_NEAREST,[nc]:r.NEAREST_MIPMAP_LINEAR,[Gn]:r.LINEAR,[ld]:r.LINEAR_MIPMAP_NEAREST,[jr]:r.LINEAR_MIPMAP_LINEAR},U={[eT]:r.NEVER,[rT]:r.ALWAYS,[tT]:r.LESS,[rm]:r.LEQUAL,[nT]:r.EQUAL,[sm]:r.GEQUAL,[iT]:r.GREATER,[aT]:r.NOTEQUAL};function ee(O,M){if(M.type===$i&&e.has("OES_texture_float_linear")===!1&&(M.magFilter===Gn||M.magFilter===ld||M.magFilter===nc||M.magFilter===jr||M.minFilter===Gn||M.minFilter===ld||M.minFilter===nc||M.minFilter===jr)&&lt("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(O,r.TEXTURE_WRAP_S,ve[M.wrapS]),r.texParameteri(O,r.TEXTURE_WRAP_T,ve[M.wrapT]),(O===r.TEXTURE_3D||O===r.TEXTURE_2D_ARRAY)&&r.texParameteri(O,r.TEXTURE_WRAP_R,ve[M.wrapR]),r.texParameteri(O,r.TEXTURE_MAG_FILTER,ye[M.magFilter]),r.texParameteri(O,r.TEXTURE_MIN_FILTER,ye[M.minFilter]),M.compareFunction&&(r.texParameteri(O,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(O,r.TEXTURE_COMPARE_FUNC,U[M.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(M.magFilter===Sn||M.minFilter!==nc&&M.minFilter!==jr||M.type===$i&&e.has("OES_texture_float_linear")===!1)return;if(M.anisotropy>1||a.get(M).__currentAnisotropy){const Y=e.get("EXT_texture_filter_anisotropic");r.texParameterf(O,Y.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(M.anisotropy,o.getMaxAnisotropy())),a.get(M).__currentAnisotropy=M.anisotropy}}}function xe(O,M){let Y=!1;O.__webglInit===void 0&&(O.__webglInit=!0,M.addEventListener("dispose",B));const pe=M.source;let be=v.get(pe);be===void 0&&(be={},v.set(pe,be));const ue=de(M);if(ue!==O.__cacheKey){be[ue]===void 0&&(be[ue]={texture:r.createTexture(),usedTimes:0},c.memory.textures++,Y=!0),be[ue].usedTimes++;const Qe=be[O.__cacheKey];Qe!==void 0&&(be[O.__cacheKey].usedTimes--,Qe.usedTimes===0&&C(M)),O.__cacheKey=ue,O.__webglTexture=be[ue].texture}return Y}function Ce(O,M,Y){return Math.floor(Math.floor(O/Y)/M)}function Ge(O,M,Y,pe){const ue=O.updateRanges;if(ue.length===0)n.texSubImage2D(r.TEXTURE_2D,0,0,0,M.width,M.height,Y,pe,M.data);else{ue.sort((Te,Ae)=>Te.start-Ae.start);let Qe=0;for(let Te=1;Te<ue.length;Te++){const Ae=ue[Qe],ze=ue[Te],Fe=Ae.start+Ae.count,Le=Ce(ze.start,M.width,4),dt=Ce(Ae.start,M.width,4);ze.start<=Fe+1&&Le===dt&&Ce(ze.start+ze.count-1,M.width,4)===Le?Ae.count=Math.max(Ae.count,ze.start+ze.count-Ae.start):(++Qe,ue[Qe]=ze)}ue.length=Qe+1;const De=r.getParameter(r.UNPACK_ROW_LENGTH),Ye=r.getParameter(r.UNPACK_SKIP_PIXELS),rt=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,M.width);for(let Te=0,Ae=ue.length;Te<Ae;Te++){const ze=ue[Te],Fe=Math.floor(ze.start/4),Le=Math.ceil(ze.count/4),dt=Fe%M.width,X=Math.floor(Fe/M.width),Oe=Le,Re=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,dt),r.pixelStorei(r.UNPACK_SKIP_ROWS,X),n.texSubImage2D(r.TEXTURE_2D,0,dt,X,Oe,Re,Y,pe,M.data)}O.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,De),r.pixelStorei(r.UNPACK_SKIP_PIXELS,Ye),r.pixelStorei(r.UNPACK_SKIP_ROWS,rt)}}function ie(O,M,Y){let pe=r.TEXTURE_2D;(M.isDataArrayTexture||M.isCompressedArrayTexture)&&(pe=r.TEXTURE_2D_ARRAY),M.isData3DTexture&&(pe=r.TEXTURE_3D);const be=xe(O,M),ue=M.source;n.bindTexture(pe,O.__webglTexture,r.TEXTURE0+Y);const Qe=a.get(ue);if(ue.version!==Qe.__version||be===!0){n.activeTexture(r.TEXTURE0+Y);const De=Ct.getPrimaries(Ct.workingColorSpace),Ye=M.colorSpace===_r?null:Ct.getPrimaries(M.colorSpace),rt=M.colorSpace===_r||De===Ye?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,M.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,M.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,rt);let Te=T(M.image,!1,o.maxTextureSize);Te=It(M,Te);const Ae=u.convert(M.format,M.colorSpace),ze=u.convert(M.type);let Fe=w(M.internalFormat,Ae,ze,M.colorSpace,M.isVideoTexture);ee(pe,M);let Le;const dt=M.mipmaps,X=M.isVideoTexture!==!0,Oe=Qe.__version===void 0||be===!0,Re=ue.dataReady,Be=P(M,Te);if(M.isDepthTexture)Fe=N(M.format===Zr,M.type),Oe&&(X?n.texStorage2D(r.TEXTURE_2D,1,Fe,Te.width,Te.height):n.texImage2D(r.TEXTURE_2D,0,Fe,Te.width,Te.height,0,Ae,ze,null));else if(M.isDataTexture)if(dt.length>0){X&&Oe&&n.texStorage2D(r.TEXTURE_2D,Be,Fe,dt[0].width,dt[0].height);for(let Me=0,Se=dt.length;Me<Se;Me++)Le=dt[Me],X?Re&&n.texSubImage2D(r.TEXTURE_2D,Me,0,0,Le.width,Le.height,Ae,ze,Le.data):n.texImage2D(r.TEXTURE_2D,Me,Fe,Le.width,Le.height,0,Ae,ze,Le.data);M.generateMipmaps=!1}else X?(Oe&&n.texStorage2D(r.TEXTURE_2D,Be,Fe,Te.width,Te.height),Re&&Ge(M,Te,Ae,ze)):n.texImage2D(r.TEXTURE_2D,0,Fe,Te.width,Te.height,0,Ae,ze,Te.data);else if(M.isCompressedTexture)if(M.isCompressedArrayTexture){X&&Oe&&n.texStorage3D(r.TEXTURE_2D_ARRAY,Be,Fe,dt[0].width,dt[0].height,Te.depth);for(let Me=0,Se=dt.length;Me<Se;Me++)if(Le=dt[Me],M.format!==zi)if(Ae!==null)if(X){if(Re)if(M.layerUpdates.size>0){const we=Iv(Le.width,Le.height,M.format,M.type);for(const st of M.layerUpdates){const Bt=Le.data.subarray(st*we/Le.data.BYTES_PER_ELEMENT,(st+1)*we/Le.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Me,0,0,st,Le.width,Le.height,1,Ae,Bt)}M.clearLayerUpdates()}else n.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Me,0,0,0,Le.width,Le.height,Te.depth,Ae,Le.data)}else n.compressedTexImage3D(r.TEXTURE_2D_ARRAY,Me,Fe,Le.width,Le.height,Te.depth,0,Le.data,0,0);else lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else X?Re&&n.texSubImage3D(r.TEXTURE_2D_ARRAY,Me,0,0,0,Le.width,Le.height,Te.depth,Ae,ze,Le.data):n.texImage3D(r.TEXTURE_2D_ARRAY,Me,Fe,Le.width,Le.height,Te.depth,0,Ae,ze,Le.data)}else{X&&Oe&&n.texStorage2D(r.TEXTURE_2D,Be,Fe,dt[0].width,dt[0].height);for(let Me=0,Se=dt.length;Me<Se;Me++)Le=dt[Me],M.format!==zi?Ae!==null?X?Re&&n.compressedTexSubImage2D(r.TEXTURE_2D,Me,0,0,Le.width,Le.height,Ae,Le.data):n.compressedTexImage2D(r.TEXTURE_2D,Me,Fe,Le.width,Le.height,0,Le.data):lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):X?Re&&n.texSubImage2D(r.TEXTURE_2D,Me,0,0,Le.width,Le.height,Ae,ze,Le.data):n.texImage2D(r.TEXTURE_2D,Me,Fe,Le.width,Le.height,0,Ae,ze,Le.data)}else if(M.isDataArrayTexture)if(X){if(Oe&&n.texStorage3D(r.TEXTURE_2D_ARRAY,Be,Fe,Te.width,Te.height,Te.depth),Re)if(M.layerUpdates.size>0){const Me=Iv(Te.width,Te.height,M.format,M.type);for(const Se of M.layerUpdates){const we=Te.data.subarray(Se*Me/Te.data.BYTES_PER_ELEMENT,(Se+1)*Me/Te.data.BYTES_PER_ELEMENT);n.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,Se,Te.width,Te.height,1,Ae,ze,we)}M.clearLayerUpdates()}else n.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,Te.width,Te.height,Te.depth,Ae,ze,Te.data)}else n.texImage3D(r.TEXTURE_2D_ARRAY,0,Fe,Te.width,Te.height,Te.depth,0,Ae,ze,Te.data);else if(M.isData3DTexture)X?(Oe&&n.texStorage3D(r.TEXTURE_3D,Be,Fe,Te.width,Te.height,Te.depth),Re&&n.texSubImage3D(r.TEXTURE_3D,0,0,0,0,Te.width,Te.height,Te.depth,Ae,ze,Te.data)):n.texImage3D(r.TEXTURE_3D,0,Fe,Te.width,Te.height,Te.depth,0,Ae,ze,Te.data);else if(M.isFramebufferTexture){if(Oe)if(X)n.texStorage2D(r.TEXTURE_2D,Be,Fe,Te.width,Te.height);else{let Me=Te.width,Se=Te.height;for(let we=0;we<Be;we++)n.texImage2D(r.TEXTURE_2D,we,Fe,Me,Se,0,Ae,ze,null),Me>>=1,Se>>=1}}else if(dt.length>0){if(X&&Oe){const Me=Ze(dt[0]);n.texStorage2D(r.TEXTURE_2D,Be,Fe,Me.width,Me.height)}for(let Me=0,Se=dt.length;Me<Se;Me++)Le=dt[Me],X?Re&&n.texSubImage2D(r.TEXTURE_2D,Me,0,0,Ae,ze,Le):n.texImage2D(r.TEXTURE_2D,Me,Fe,Ae,ze,Le);M.generateMipmaps=!1}else if(X){if(Oe){const Me=Ze(Te);n.texStorage2D(r.TEXTURE_2D,Be,Fe,Me.width,Me.height)}Re&&n.texSubImage2D(r.TEXTURE_2D,0,0,0,Ae,ze,Te)}else n.texImage2D(r.TEXTURE_2D,0,Fe,Ae,ze,Te);y(M)&&x(pe),Qe.__version=ue.version,M.onUpdate&&M.onUpdate(M)}O.__version=M.version}function fe(O,M,Y){if(M.image.length!==6)return;const pe=xe(O,M),be=M.source;n.bindTexture(r.TEXTURE_CUBE_MAP,O.__webglTexture,r.TEXTURE0+Y);const ue=a.get(be);if(be.version!==ue.__version||pe===!0){n.activeTexture(r.TEXTURE0+Y);const Qe=Ct.getPrimaries(Ct.workingColorSpace),De=M.colorSpace===_r?null:Ct.getPrimaries(M.colorSpace),Ye=M.colorSpace===_r||Qe===De?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,M.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,M.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,M.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ye);const rt=M.isCompressedTexture||M.image[0].isCompressedTexture,Te=M.image[0]&&M.image[0].isDataTexture,Ae=[];for(let Se=0;Se<6;Se++)!rt&&!Te?Ae[Se]=T(M.image[Se],!0,o.maxCubemapSize):Ae[Se]=Te?M.image[Se].image:M.image[Se],Ae[Se]=It(M,Ae[Se]);const ze=Ae[0],Fe=u.convert(M.format,M.colorSpace),Le=u.convert(M.type),dt=w(M.internalFormat,Fe,Le,M.colorSpace),X=M.isVideoTexture!==!0,Oe=ue.__version===void 0||pe===!0,Re=be.dataReady;let Be=P(M,ze);ee(r.TEXTURE_CUBE_MAP,M);let Me;if(rt){X&&Oe&&n.texStorage2D(r.TEXTURE_CUBE_MAP,Be,dt,ze.width,ze.height);for(let Se=0;Se<6;Se++){Me=Ae[Se].mipmaps;for(let we=0;we<Me.length;we++){const st=Me[we];M.format!==zi?Fe!==null?X?Re&&n.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,we,0,0,st.width,st.height,Fe,st.data):n.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,we,dt,st.width,st.height,0,st.data):lt("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):X?Re&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,we,0,0,st.width,st.height,Fe,Le,st.data):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,we,dt,st.width,st.height,0,Fe,Le,st.data)}}}else{if(Me=M.mipmaps,X&&Oe){Me.length>0&&Be++;const Se=Ze(Ae[0]);n.texStorage2D(r.TEXTURE_CUBE_MAP,Be,dt,Se.width,Se.height)}for(let Se=0;Se<6;Se++)if(Te){X?Re&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,0,0,0,Ae[Se].width,Ae[Se].height,Fe,Le,Ae[Se].data):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,0,dt,Ae[Se].width,Ae[Se].height,0,Fe,Le,Ae[Se].data);for(let we=0;we<Me.length;we++){const Bt=Me[we].image[Se].image;X?Re&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,we+1,0,0,Bt.width,Bt.height,Fe,Le,Bt.data):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,we+1,dt,Bt.width,Bt.height,0,Fe,Le,Bt.data)}}else{X?Re&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,0,0,0,Fe,Le,Ae[Se]):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,0,dt,Fe,Le,Ae[Se]);for(let we=0;we<Me.length;we++){const st=Me[we];X?Re&&n.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,we+1,0,0,Fe,Le,st.image[Se]):n.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+Se,we+1,dt,Fe,Le,st.image[Se])}}}y(M)&&x(r.TEXTURE_CUBE_MAP),ue.__version=be.version,M.onUpdate&&M.onUpdate(M)}O.__version=M.version}function Ue(O,M,Y,pe,be,ue){const Qe=u.convert(Y.format,Y.colorSpace),De=u.convert(Y.type),Ye=w(Y.internalFormat,Qe,De,Y.colorSpace),rt=a.get(M),Te=a.get(Y);if(Te.__renderTarget=M,!rt.__hasExternalTextures){const Ae=Math.max(1,M.width>>ue),ze=Math.max(1,M.height>>ue);be===r.TEXTURE_3D||be===r.TEXTURE_2D_ARRAY?n.texImage3D(be,ue,Ye,Ae,ze,M.depth,0,Qe,De,null):n.texImage2D(be,ue,Ye,Ae,ze,0,Qe,De,null)}n.bindFramebuffer(r.FRAMEBUFFER,O),Jt(M)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,pe,be,Te.__webglTexture,0,G(M)):(be===r.TEXTURE_2D||be>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&be<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,pe,be,Te.__webglTexture,ue),n.bindFramebuffer(r.FRAMEBUFFER,null)}function We(O,M,Y){if(r.bindRenderbuffer(r.RENDERBUFFER,O),M.depthBuffer){const pe=M.depthTexture,be=pe&&pe.isDepthTexture?pe.type:null,ue=N(M.stencilBuffer,be),Qe=M.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;Jt(M)?h.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,G(M),ue,M.width,M.height):Y?r.renderbufferStorageMultisample(r.RENDERBUFFER,G(M),ue,M.width,M.height):r.renderbufferStorage(r.RENDERBUFFER,ue,M.width,M.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Qe,r.RENDERBUFFER,O)}else{const pe=M.textures;for(let be=0;be<pe.length;be++){const ue=pe[be],Qe=u.convert(ue.format,ue.colorSpace),De=u.convert(ue.type),Ye=w(ue.internalFormat,Qe,De,ue.colorSpace);Jt(M)?h.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,G(M),Ye,M.width,M.height):Y?r.renderbufferStorageMultisample(r.RENDERBUFFER,G(M),Ye,M.width,M.height):r.renderbufferStorage(r.RENDERBUFFER,Ye,M.width,M.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Ve(O,M,Y){const pe=M.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(r.FRAMEBUFFER,O),!(M.depthTexture&&M.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const be=a.get(M.depthTexture);if(be.__renderTarget=M,(!be.__webglTexture||M.depthTexture.image.width!==M.width||M.depthTexture.image.height!==M.height)&&(M.depthTexture.image.width=M.width,M.depthTexture.image.height=M.height,M.depthTexture.needsUpdate=!0),pe){if(be.__webglInit===void 0&&(be.__webglInit=!0,M.depthTexture.addEventListener("dispose",B)),be.__webglTexture===void 0){be.__webglTexture=r.createTexture(),n.bindTexture(r.TEXTURE_CUBE_MAP,be.__webglTexture),ee(r.TEXTURE_CUBE_MAP,M.depthTexture);const rt=u.convert(M.depthTexture.format),Te=u.convert(M.depthTexture.type);let Ae;M.depthTexture.format===Oa?Ae=r.DEPTH_COMPONENT24:M.depthTexture.format===Zr&&(Ae=r.DEPTH24_STENCIL8);for(let ze=0;ze<6;ze++)r.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+ze,0,Ae,M.width,M.height,0,rt,Te,null)}}else ce(M.depthTexture,0);const ue=be.__webglTexture,Qe=G(M),De=pe?r.TEXTURE_CUBE_MAP_POSITIVE_X+Y:r.TEXTURE_2D,Ye=M.depthTexture.format===Zr?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;if(M.depthTexture.format===Oa)Jt(M)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Ye,De,ue,0,Qe):r.framebufferTexture2D(r.FRAMEBUFFER,Ye,De,ue,0);else if(M.depthTexture.format===Zr)Jt(M)?h.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Ye,De,ue,0,Qe):r.framebufferTexture2D(r.FRAMEBUFFER,Ye,De,ue,0);else throw new Error("Unknown depthTexture format")}function gt(O){const M=a.get(O),Y=O.isWebGLCubeRenderTarget===!0;if(M.__boundDepthTexture!==O.depthTexture){const pe=O.depthTexture;if(M.__depthDisposeCallback&&M.__depthDisposeCallback(),pe){const be=()=>{delete M.__boundDepthTexture,delete M.__depthDisposeCallback,pe.removeEventListener("dispose",be)};pe.addEventListener("dispose",be),M.__depthDisposeCallback=be}M.__boundDepthTexture=pe}if(O.depthTexture&&!M.__autoAllocateDepthBuffer)if(Y)for(let pe=0;pe<6;pe++)Ve(M.__webglFramebuffer[pe],O,pe);else{const pe=O.texture.mipmaps;pe&&pe.length>0?Ve(M.__webglFramebuffer[0],O,0):Ve(M.__webglFramebuffer,O,0)}else if(Y){M.__webglDepthbuffer=[];for(let pe=0;pe<6;pe++)if(n.bindFramebuffer(r.FRAMEBUFFER,M.__webglFramebuffer[pe]),M.__webglDepthbuffer[pe]===void 0)M.__webglDepthbuffer[pe]=r.createRenderbuffer(),We(M.__webglDepthbuffer[pe],O,!1);else{const be=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ue=M.__webglDepthbuffer[pe];r.bindRenderbuffer(r.RENDERBUFFER,ue),r.framebufferRenderbuffer(r.FRAMEBUFFER,be,r.RENDERBUFFER,ue)}}else{const pe=O.texture.mipmaps;if(pe&&pe.length>0?n.bindFramebuffer(r.FRAMEBUFFER,M.__webglFramebuffer[0]):n.bindFramebuffer(r.FRAMEBUFFER,M.__webglFramebuffer),M.__webglDepthbuffer===void 0)M.__webglDepthbuffer=r.createRenderbuffer(),We(M.__webglDepthbuffer,O,!1);else{const be=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ue=M.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,ue),r.framebufferRenderbuffer(r.FRAMEBUFFER,be,r.RENDERBUFFER,ue)}}n.bindFramebuffer(r.FRAMEBUFFER,null)}function an(O,M,Y){const pe=a.get(O);M!==void 0&&Ue(pe.__webglFramebuffer,O,O.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),Y!==void 0&&gt(O)}function Et(O){const M=O.texture,Y=a.get(O),pe=a.get(M);O.addEventListener("dispose",I);const be=O.textures,ue=O.isWebGLCubeRenderTarget===!0,Qe=be.length>1;if(Qe||(pe.__webglTexture===void 0&&(pe.__webglTexture=r.createTexture()),pe.__version=M.version,c.memory.textures++),ue){Y.__webglFramebuffer=[];for(let De=0;De<6;De++)if(M.mipmaps&&M.mipmaps.length>0){Y.__webglFramebuffer[De]=[];for(let Ye=0;Ye<M.mipmaps.length;Ye++)Y.__webglFramebuffer[De][Ye]=r.createFramebuffer()}else Y.__webglFramebuffer[De]=r.createFramebuffer()}else{if(M.mipmaps&&M.mipmaps.length>0){Y.__webglFramebuffer=[];for(let De=0;De<M.mipmaps.length;De++)Y.__webglFramebuffer[De]=r.createFramebuffer()}else Y.__webglFramebuffer=r.createFramebuffer();if(Qe)for(let De=0,Ye=be.length;De<Ye;De++){const rt=a.get(be[De]);rt.__webglTexture===void 0&&(rt.__webglTexture=r.createTexture(),c.memory.textures++)}if(O.samples>0&&Jt(O)===!1){Y.__webglMultisampledFramebuffer=r.createFramebuffer(),Y.__webglColorRenderbuffer=[],n.bindFramebuffer(r.FRAMEBUFFER,Y.__webglMultisampledFramebuffer);for(let De=0;De<be.length;De++){const Ye=be[De];Y.__webglColorRenderbuffer[De]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,Y.__webglColorRenderbuffer[De]);const rt=u.convert(Ye.format,Ye.colorSpace),Te=u.convert(Ye.type),Ae=w(Ye.internalFormat,rt,Te,Ye.colorSpace,O.isXRRenderTarget===!0),ze=G(O);r.renderbufferStorageMultisample(r.RENDERBUFFER,ze,Ae,O.width,O.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+De,r.RENDERBUFFER,Y.__webglColorRenderbuffer[De])}r.bindRenderbuffer(r.RENDERBUFFER,null),O.depthBuffer&&(Y.__webglDepthRenderbuffer=r.createRenderbuffer(),We(Y.__webglDepthRenderbuffer,O,!0)),n.bindFramebuffer(r.FRAMEBUFFER,null)}}if(ue){n.bindTexture(r.TEXTURE_CUBE_MAP,pe.__webglTexture),ee(r.TEXTURE_CUBE_MAP,M);for(let De=0;De<6;De++)if(M.mipmaps&&M.mipmaps.length>0)for(let Ye=0;Ye<M.mipmaps.length;Ye++)Ue(Y.__webglFramebuffer[De][Ye],O,M,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+De,Ye);else Ue(Y.__webglFramebuffer[De],O,M,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+De,0);y(M)&&x(r.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Qe){for(let De=0,Ye=be.length;De<Ye;De++){const rt=be[De],Te=a.get(rt);let Ae=r.TEXTURE_2D;(O.isWebGL3DRenderTarget||O.isWebGLArrayRenderTarget)&&(Ae=O.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),n.bindTexture(Ae,Te.__webglTexture),ee(Ae,rt),Ue(Y.__webglFramebuffer,O,rt,r.COLOR_ATTACHMENT0+De,Ae,0),y(rt)&&x(Ae)}n.unbindTexture()}else{let De=r.TEXTURE_2D;if((O.isWebGL3DRenderTarget||O.isWebGLArrayRenderTarget)&&(De=O.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),n.bindTexture(De,pe.__webglTexture),ee(De,M),M.mipmaps&&M.mipmaps.length>0)for(let Ye=0;Ye<M.mipmaps.length;Ye++)Ue(Y.__webglFramebuffer[Ye],O,M,r.COLOR_ATTACHMENT0,De,Ye);else Ue(Y.__webglFramebuffer,O,M,r.COLOR_ATTACHMENT0,De,0);y(M)&&x(De),n.unbindTexture()}O.depthBuffer&&gt(O)}function vt(O){const M=O.textures;for(let Y=0,pe=M.length;Y<pe;Y++){const be=M[Y];if(y(be)){const ue=D(O),Qe=a.get(be).__webglTexture;n.bindTexture(ue,Qe),x(ue),n.unbindTexture()}}}const Ut=[],ft=[];function rn(O){if(O.samples>0){if(Jt(O)===!1){const M=O.textures,Y=O.width,pe=O.height;let be=r.COLOR_BUFFER_BIT;const ue=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Qe=a.get(O),De=M.length>1;if(De)for(let rt=0;rt<M.length;rt++)n.bindFramebuffer(r.FRAMEBUFFER,Qe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+rt,r.RENDERBUFFER,null),n.bindFramebuffer(r.FRAMEBUFFER,Qe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+rt,r.TEXTURE_2D,null,0);n.bindFramebuffer(r.READ_FRAMEBUFFER,Qe.__webglMultisampledFramebuffer);const Ye=O.texture.mipmaps;Ye&&Ye.length>0?n.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qe.__webglFramebuffer[0]):n.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qe.__webglFramebuffer);for(let rt=0;rt<M.length;rt++){if(O.resolveDepthBuffer&&(O.depthBuffer&&(be|=r.DEPTH_BUFFER_BIT),O.stencilBuffer&&O.resolveStencilBuffer&&(be|=r.STENCIL_BUFFER_BIT)),De){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Qe.__webglColorRenderbuffer[rt]);const Te=a.get(M[rt]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,Te,0)}r.blitFramebuffer(0,0,Y,pe,0,0,Y,pe,be,r.NEAREST),p===!0&&(Ut.length=0,ft.length=0,Ut.push(r.COLOR_ATTACHMENT0+rt),O.depthBuffer&&O.resolveDepthBuffer===!1&&(Ut.push(ue),ft.push(ue),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,ft)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Ut))}if(n.bindFramebuffer(r.READ_FRAMEBUFFER,null),n.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),De)for(let rt=0;rt<M.length;rt++){n.bindFramebuffer(r.FRAMEBUFFER,Qe.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+rt,r.RENDERBUFFER,Qe.__webglColorRenderbuffer[rt]);const Te=a.get(M[rt]).__webglTexture;n.bindFramebuffer(r.FRAMEBUFFER,Qe.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+rt,r.TEXTURE_2D,Te,0)}n.bindFramebuffer(r.DRAW_FRAMEBUFFER,Qe.__webglMultisampledFramebuffer)}else if(O.depthBuffer&&O.resolveDepthBuffer===!1&&p){const M=O.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[M])}}}function G(O){return Math.min(o.maxSamples,O.samples)}function Jt(O){const M=a.get(O);return O.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&M.__useRenderToTexture!==!1}function At(O){const M=c.render.frame;g.get(O)!==M&&(g.set(O,M),O.update())}function It(O,M){const Y=O.colorSpace,pe=O.format,be=O.type;return O.isCompressedTexture===!0||O.isVideoTexture===!0||Y!==lo&&Y!==_r&&(Ct.getTransfer(Y)===Vt?(pe!==zi||be!==Ai)&&lt("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):Lt("WebGLTextures: Unsupported texture color space:",Y)),M}function Ze(O){return typeof HTMLImageElement<"u"&&O instanceof HTMLImageElement?(m.width=O.naturalWidth||O.width,m.height=O.naturalHeight||O.height):typeof VideoFrame<"u"&&O instanceof VideoFrame?(m.width=O.displayWidth,m.height=O.displayHeight):(m.width=O.width,m.height=O.height),m}this.allocateTextureUnit=ae,this.resetTextureUnits=re,this.setTexture2D=ce,this.setTexture2DArray=F,this.setTexture3D=H,this.setTextureCube=W,this.rebindTextures=an,this.setupRenderTarget=Et,this.updateRenderTargetMipmap=vt,this.updateMultisampleRenderTarget=rn,this.setupDepthRenderbuffer=gt,this.setupFrameBufferTexture=Ue,this.useMultisampledRTT=Jt,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function Nw(r,e){function n(a,o=_r){let u;const c=Ct.getTransfer(o);if(a===Ai)return r.UNSIGNED_BYTE;if(a===em)return r.UNSIGNED_SHORT_4_4_4_4;if(a===tm)return r.UNSIGNED_SHORT_5_5_5_1;if(a===tS)return r.UNSIGNED_INT_5_9_9_9_REV;if(a===nS)return r.UNSIGNED_INT_10F_11F_11F_REV;if(a===$x)return r.BYTE;if(a===eS)return r.SHORT;if(a===Cl)return r.UNSIGNED_SHORT;if(a===$p)return r.INT;if(a===aa)return r.UNSIGNED_INT;if(a===$i)return r.FLOAT;if(a===fi)return r.HALF_FLOAT;if(a===iS)return r.ALPHA;if(a===aS)return r.RGB;if(a===zi)return r.RGBA;if(a===Oa)return r.DEPTH_COMPONENT;if(a===Zr)return r.DEPTH_STENCIL;if(a===rS)return r.RED;if(a===nm)return r.RED_INTEGER;if(a===oo)return r.RG;if(a===im)return r.RG_INTEGER;if(a===am)return r.RGBA_INTEGER;if(a===wc||a===Dc||a===Lc||a===Uc)if(c===Vt)if(u=e.get("WEBGL_compressed_texture_s3tc_srgb"),u!==null){if(a===wc)return u.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(a===Dc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(a===Lc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(a===Uc)return u.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(u=e.get("WEBGL_compressed_texture_s3tc"),u!==null){if(a===wc)return u.COMPRESSED_RGB_S3TC_DXT1_EXT;if(a===Dc)return u.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(a===Lc)return u.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(a===Uc)return u.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(a===rp||a===sp||a===op||a===lp)if(u=e.get("WEBGL_compressed_texture_pvrtc"),u!==null){if(a===rp)return u.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(a===sp)return u.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(a===op)return u.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(a===lp)return u.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(a===up||a===cp||a===fp||a===hp||a===dp||a===pp||a===mp)if(u=e.get("WEBGL_compressed_texture_etc"),u!==null){if(a===up||a===cp)return c===Vt?u.COMPRESSED_SRGB8_ETC2:u.COMPRESSED_RGB8_ETC2;if(a===fp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:u.COMPRESSED_RGBA8_ETC2_EAC;if(a===hp)return u.COMPRESSED_R11_EAC;if(a===dp)return u.COMPRESSED_SIGNED_R11_EAC;if(a===pp)return u.COMPRESSED_RG11_EAC;if(a===mp)return u.COMPRESSED_SIGNED_RG11_EAC}else return null;if(a===_p||a===gp||a===vp||a===xp||a===Sp||a===yp||a===Ep||a===bp||a===Mp||a===Tp||a===Ap||a===Rp||a===Cp||a===wp)if(u=e.get("WEBGL_compressed_texture_astc"),u!==null){if(a===_p)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:u.COMPRESSED_RGBA_ASTC_4x4_KHR;if(a===gp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:u.COMPRESSED_RGBA_ASTC_5x4_KHR;if(a===vp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:u.COMPRESSED_RGBA_ASTC_5x5_KHR;if(a===xp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:u.COMPRESSED_RGBA_ASTC_6x5_KHR;if(a===Sp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:u.COMPRESSED_RGBA_ASTC_6x6_KHR;if(a===yp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:u.COMPRESSED_RGBA_ASTC_8x5_KHR;if(a===Ep)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:u.COMPRESSED_RGBA_ASTC_8x6_KHR;if(a===bp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:u.COMPRESSED_RGBA_ASTC_8x8_KHR;if(a===Mp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:u.COMPRESSED_RGBA_ASTC_10x5_KHR;if(a===Tp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:u.COMPRESSED_RGBA_ASTC_10x6_KHR;if(a===Ap)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:u.COMPRESSED_RGBA_ASTC_10x8_KHR;if(a===Rp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:u.COMPRESSED_RGBA_ASTC_10x10_KHR;if(a===Cp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:u.COMPRESSED_RGBA_ASTC_12x10_KHR;if(a===wp)return c===Vt?u.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:u.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(a===Dp||a===Lp||a===Up)if(u=e.get("EXT_texture_compression_bptc"),u!==null){if(a===Dp)return c===Vt?u.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:u.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(a===Lp)return u.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(a===Up)return u.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(a===Np||a===Op||a===Pp||a===Ip)if(u=e.get("EXT_texture_compression_rgtc"),u!==null){if(a===Np)return u.COMPRESSED_RED_RGTC1_EXT;if(a===Op)return u.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(a===Pp)return u.COMPRESSED_RED_GREEN_RGTC2_EXT;if(a===Ip)return u.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return a===wl?r.UNSIGNED_INT_24_8:r[a]!==void 0?r[a]:null}return{convert:n}}const Ow=`
void main() {
...
`,n2={name:"DitherColorShader",uniforms:{tDiffuse:{value:null},uResolution:{value:new nt(window.innerWidth,window.innerHeight)},uColor1:{value:new _t(131589)},uColor2:{value:new _t(657966)},uColor3:{value:new _t(13216)},uColor4:{value:new _t(51455)},uColor5:{value:new _t(7143418)},uColor6:{value:new _t(15138815)}},vertexShader:`
    ...
    `,fragmentShader:t2};class i2{constructor(){this.position=new K(0,0,0),this.velocity=new K(0,0,0),this.orientation=new ct,this.time=0}orbitalFrame(){const e=new K().subVectors(this.velocity.clone().normalize().multiplyScalar(4),this.position).normalize(),n=new K().crossVectors(this.position,e).normalize(),a=new K().crossVectors(e,n).normalize(),o=new tn;o.makeBasis(a,e,n);const u=new ct;return u.setFromMatrix4(o),u}move(e,n){e*=n.time_scale;let a,o=0;if(n.observer.motion){a=n.observer.distance,o=1/Math.sqrt(2*(a-1));const u=o/a,c=this.time*u,h=Math.sin(c),p=Math.cos(c);this.position.set(p*a,h*a,1),this.velocity.set(-h*o,p*o,0);const g=(v=>Math.PI*v/180)(n.observer.orbital_inclination),_=new tn().makeRotationY(g);this.position.applyMatrix4(_),this.velocity.applyMatrix4(_)}else a=this.position.length();n.gravitational_time_dilation&&(e=Math.sqrt(e*e*(1-o*o)/(1-1/a))),this.time+=e}}class a2{constructor(e){this.template=e,this.parameters={n_steps:100,quality:"medium",accretion_disk:!0,planet:{enabled:!0,distance:7,radius:.4},lorentz_contraction:!0,gravitational_time_dilation:!0,aberration:!0,beaming:!0,doppler_shift:!0,light_travel_time:!0,time_scale:5,observer:{motion:!0,distance:30,orbital_inclination:-1},planetEnabled:function(){return this.planet.enabled&&this.quality!=="fast"},observerMotion:function(){return this.observer.motion},camera:{cinematic:!0,roll:0}},this.needsUpdate=!0}hasMovingParts(){return this.parameters.planet.enabled||this.parameters.observer.motion}compile(){return Ri.render(this.template,this.parameters)}}const bx=r=>Math.PI*r/180,r2=()=>{const r=me.useRef(null),e=me.useRef(null),n=me.useRef(null),a=me.useRef(null);return me.useEffect(()=>{const o=r.current,u=window.innerWidth,c=window.innerHeight,h=new UT;e.current=h;const p=new Ti(90,u/c,1,8e3),m=new kw;m.setPixelRatio(.6),m.setSize(u,c),o.appendChild(m.domElement);const g=new p3;g.domElement.style.position="absolute",g.domElement.style.top="0px",o.appendChild(g.domElement);const _=new i2;a.current=_;const v=new a2(e2);n.current=v;const E=new XT,b={galaxy:E.load("/img/gradient7.png"),spectra:E.load("/img/spectra.png"),moon:E.load("/img/berserk.jpg"),accretion_disk:E.load("/img/gradient15.png"),stars:E.load("/img/stars1.png")};b.galaxy.magFilter=Sn,b.galaxy.minFilter=Sn;const T=new Gl(2,2),y={time:{value:0},resolution:{value:new nt(u,c)},cam_pos:{value:new K},cam_x:{value:new K},cam_y:{value:new K},cam_z:{value:new K},cam_vel:{value:new K},planet_distance:{value:v.parameters.planet.distance},planet_radius:{value:v.parameters.planet.radius},star_texture:{value:b.stars},accretion_disk_texture:{value:b.accretion_disk},galaxy_texture:{value:b.galaxy},planet_texture:{value:b.moon},spectrum_texture:{value:b.spectra}},x=new In({uniforms:y,vertexShader:$3,fragmentShader:v.compile()}),D=new Vi(T,x);h.add(D);const w=new Ww(p,m.domElement);w.target.set(0,0,0),(()=>{p.matrixWorldInverse.makeRotationX(bx(-0)),p.matrixWorldInverse.multiply(new tn().makeRotationY(bx(-0)));const W=p.matrixWorldInverse.elements;p.position.set(W[2],W[6],W[10])})();const P=new l3(m),B=new u3(h,p);P.addPass(B);const I=new co(new nt(u,c),.1,.1,0);P.addPass(I);const j=new AS(n2);j.uniforms.uResolution.value.set(u,c),P.addPass(j);const C=new I3({autoPlace:!1});C.domElement.style.position="absolute",C.domElement.style.top="0px",C.domElement.style.right="0px",o.appendChild(C.domElement);const L=()=>{const W=p.matrixWorldInverse.elements;let ve;if(v.parameters.observer.motion?ve=new ct:ve=_.orientation,ve.set(W[0],W[1],W[2],W[8],W[9],W[10],W[4],W[5],W[6]),v.parameters.observer.motion)_.orientation=_.orbitalFrame().multiply(ve);else{const ye=new K(W[6],W[7],W[8]),U=v.parameters.observer.distance;_.position.set(-ye.x*U,-ye.y*U,-ye.z*U),_.velocity.set(0,0,0)}};w.addEventListener("change",L),L();const k=()=>{y.planet_distance.value=v.parameters.planet.distance,y.planet_radius.value=v.parameters.planet.radius,y.resolution.value.set(m.domElement.width,m.domElement.height),y.time.value=_.time,y.cam_pos.value.copy(_.position),y.cam_vel.value.copy(_.velocity);const W=_.orientation.elements;console.log(W),y.cam_x.value.set(W[0],W[1],W[2]),y.cam_y.value.set(W[3],W[4],W[5]),y.cam_z.value.set(W[6],W[7],W[8])};let re=new tn().identity(),ae=performance.now(),de;const ce=(W,ve)=>{let ye=0;for(let U=0;U<16;U++){const ee=W.elements[U]-ve.elements[U];ye+=ee*ee}return Math.sqrt(ye)},F=()=>{de=requestAnimationFrame(F);const W=performance.now(),ve=(W-ae)/1e3;ae=W,_.move(ve,v.parameters),v.parameters.observer.motion&&L(),k(),p.updateMatrixWorld(),p.matrixWorldInverse.copy(p.matrixWorld).invert(),(v.needsUpdate||v.hasMovingParts()||ce(p.matrixWorldInverse,re)>1e-10)&&(v.needsUpdate=!1,P.render(),re.copy(p.matrixWorldInverse)),g.update()};F();const H=()=>{const W=window.innerWidth,ve=window.innerHeight;m.setSize(W,ve),p.aspect=W/ve,p.updateProjectionMatrix(),P.setSize(W,ve),I.resolution.set(W,ve),j.uniforms.uResolution.value.set(W,ve)};return window.addEventListener("resize",H),()=>{cancelAnimationFrame(de),window.removeEventListener("resize",H),w.dispose(),C.destroy(),m.dispose(),o&&(o.innerHTML="")}},[]),tt.jsx("div",{ref:r,style:{width:"100%",height:"100vh",overflow:"hidden",pointerEvents:"none",touchAction:"none"}})},s2=()=>tt.jsxs("div",{className:"landing-container",children:[tt.jsx("div",{className:"three-scene-wrapper",children:tt.jsx(r2,{})}),tt.jsxs("div",{className:"landing-overlay",children:[tt.jsx("h1",{className:"landing-title"}),tt.jsx("p",{className:"landing-subtitle"})]})]}),o2=()=>tt.jsx("div",{className:"about-container",children:tt.jsxs("div",{className:"about-content",children:[tt.jsxs("div",{className:"grid-section hero-section",children:[tt.jsx("h1",{className:"section-title",children:"About This Project"}),tt.jsx("p",{className:"section-text",children:"Exploring the intersection of astrophysics and interactive visualization."})]}),tt.jsxs("div",{className:"grid-layout",children:[tt.jsxs("div",{className:"grid-item card-1",children:[tt.jsx("h2",{children:"The Black Hole Simulation"}),tt.jsx("p",{children:"This interactive visualization uses real-time ray-tracing to simulate gravitational lensing around a Schwarzschild black hole. Watch as light bends around the event horizon, creating stunning visual effects."})]}),tt.jsxs("div",{className:"grid-item card-2",children:[tt.jsx("h2",{children:"Physics Behind It"}),tt.jsx("p",{children:"The simulation accounts for general relativistic effects including gravitational lensing, Doppler shifting, and the warping of spacetime around massive objects."})]}),tt.jsxs("div",{className:"grid-item card-3",children:[tt.jsx("h2",{children:"Technical Features"}),tt.jsxs("ul",{children:[tt.jsx("li",{children:"Real-time GLSL Ray Tracing"}),tt.jsx("li",{children:"Accretion Disk Rendering"}),tt.jsx("li",{children:"Interactive Camera Controls"}),tt.jsx("li",{children:"WebGL Powered Graphics"})]})]}),tt.jsxs("div",{className:"grid-item card-4",children:[tt.jsx("h2",{children:"How to Interact"}),tt.jsx("p",{children:"Use your mouse to drag and rotate the view. The simulation runs continuously, showing the orbital dynamics around the black hole."})]}),tt.jsxs("div",{className:"grid-item card-5 full-width",children:[tt.jsx("h2",{children:"Learn More"}),tt.jsx("p",{children:"This visualization is inspired by real astrophysics research and demonstrates the power of modern web technologies to bring complex scientific concepts to life."}),tt.jsxs("div",{className:"contact-buttons",children:[tt.jsx("button",{className:"btn-primary",children:"Back to Simulation"}),tt.jsx("button",{className:"btn-secondary",children:"Technical Details"})]})]})]})]})});function l2(){return tt.jsx(_M,{children:tt.jsxs("div",{className:"app",children:[tt.jsx(AM,{}),tt.jsxs(Yb,{children:[tt.jsx(kd,{path:"/",element:tt.jsx(s2,{})}),tt.jsx(kd,{path:"/about",element:tt.jsx(o2,{})})]})]})})}jE.createRoot(document.getElementById("root")).render(tt.jsx(me.StrictMode,{children:tt.jsx(l2,{})}));
